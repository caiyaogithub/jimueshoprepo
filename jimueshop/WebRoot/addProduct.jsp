...
<body>
	<form action="product/addProduct" method = "post" enctype="multipart/form-data" >
		...
		<input type ="text" value = "2" name = "product.subType.id"  /><br/>
		...
		<input type = "text" value ="46" name = "attrItems[0].id"/><br/>　 
		<input type = "text" value ="47" name = "attrItems[1].id"/><br/>　 
		<input type = "text" value ="48" name = "attrItems[2].id"/><br/>　 
